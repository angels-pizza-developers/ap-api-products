...
class PaginationParamsDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { pageSize: { required: true, type: () => String }, pageIndex: { required: true, type: () => String }, order: { required: true, type: () => Object, default: {} }, columnDef: { required: true, type: () => Object, default: [] } };
    }
}
